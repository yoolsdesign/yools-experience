...
*/
	...
	function send_welcome_email_to_new_user($user_id) {
	    ...
	    $subject = "Kraak de champagne, je website staat online!";

	    $body = '
	    		<div style="background-color: #eaeced; padding: 60px 0;"> 

	    		<img src="https://raw.githubusercontent.com/yoolsdesign/yools-experience/master/public/images/yools-logo.png" style="display: block; margin: 0 auto 60px auto; max-width: 260px;">

	    		<div style="text-align: center; max-width: 600px; display: block; margin: 0 auto; background-color: #fff; padding: 70px; border-top: #ffbe23 10px solid;">

	    		<img src="https://raw.githubusercontent.com/yoolsdesign/yools-experience/master/public/images/mails/online.png" style="max-width: 200px;">

	            <h2 style="font-family: Open Sans, sans-serif;">Hey ' . $user->user_firstname . '!</h2>

	            <p style="font-family: Open Sans, sans-serif; font-size: 16px; line-height: 1.75em;">Yes! Het is zover! Schuif alles aan de kant! Dé grote dag...! <strong>Je website staat online</strong>. Je staat ongetwijfeld te popelen om zelf aan de slag te gaan met je nieuwe "speelgoed" en de mogelijkheden ervan te ontdekken. Maar voor je daar kan induiken, moet je eerst twee zaken in orde brengen:<br><br>1. Kies <a target="_blank" href="' . wp_login_url(). '?action=rp&key=' . $key . '&login=' . rawurlencode($user->user_login) . '">hier</a> een veilig wachtwoord. Met dit wachtwoord zal je kunnen inloggen op de website.<br>2. Bekijk onze <a href="http://support.yools.be" target="_blank">uitgebreide helpdesk</a> en leer de skills van een echte professionele webmaster.<br><br>Ben je niet zo’n doe-het-zelver maar wil je wél een website die altijd up-to-date is? Kies voor ons Full Service pakket of <a href="https://support.yools.be/support/tickets/new" target="_blank">boek een Live Support Sessie</a>.<br><br>Feestelijke groeten,<br><span style="color: #ffbe23; font-weight: bold;">De Yoolsies</span></p>
	            </div>
	            </div>'

	    ;

	    $headers = array('Content-Type: text/html; charset=UTF-8','From: Yools <support@yools.be>');
  ...
  /**
	...
	*/
	...
	public function replace_retrieve_password_message( $message, $key, $user_login, $user_data ) {
			...
			$msg .= __( "Je vroeg ons om je wachtwoord voor jouw account opnieuw in te stellen.", 'yools-experience' ) . "\r\n";
			...
			$msg .= __( 'Ga naar de volgende link om je wachtwoord opnieuw in te stellen:', 'yools-experience' ) . "\r\n";

			$msg .= site_url( "wp-login.php?action=rp&key=$key&login=" . rawurlencode( $user_login ), 'yools-experience' ) . "\r\n\r\n";

			$msg .= __( 'Zoemende groetjes!', 'yools-experience' ) . "\r\n";

			$msg .= __( 'De Yoolsies', 'yools-experience' ) . "\r\n";
